        ...
        <div className="hidden md:flex items-center gap-3">
          {user ? (
            ...
            <>
              <Link
                to="/login"
                className="text-sm text-maroon font-medium hover:text-maroon-dark transition-colors duration-200"
              >
                Login
              </Link>
              <Link
                to="/signup"
                className="text-sm bg-maroon text-white px-4 py-2 rounded-lg hover:bg-maroon-dark transition-colors duration-200"
              >
                Sign Up
              </Link>
            </>
