      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="max-w-7xl mx-auto px-4 w-full">
          <p className="text-white/80 text-sm tracking-widest uppercase mb-4">
            {siteConfig.established} · Coimbatore, Tamil Nadu
          </p>
          ...
          <p className="text-white/90 text-lg md:text-xl max-w-2xl mb-8">
            {siteConfig.tagline}. Premier engineering institution with 92%
            placement rate and partnerships with Google, Microsoft & Amazon.
          </p>
          <a
            href="#courses"
